...
String City             = "shenzhen";                          // Your home city See: http://bulk.openweathermap.org/sample/
String Latitude         = "22.32";                         // Latitude of your location in decimal degrees
String Longitude        = "114.03";                         // Longitude of your location in decimal degrees
...
const char* ntpServer   = "0.cn.pool.ntp.org";             // Or, choose a time server close to you, but in most cases it's best to use pool.ntp.org to find an NTP server
